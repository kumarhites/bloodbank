  ...
  require 'db_connect.php';
    ...
    if(!mysqli_stmt_prepare($stmt, $sql)){
      ...
      if($row = mysqli_fetch_assoc($result)){
        $password_check = password_verify($password, $row['h_password']);
        if($password_check == false){
          echo "<script>alert('Invalid Username or Password Combination!')</script>";
          exit();
        }
        else{
          $_SESSION['hospitalId'] = $row['h_id'];
...
<body>
    ...
    <section class="card container-fluid px-3 py-3">
     <div class="text-center">
      <svg class="text-center" id="download" xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 104.714 113.639">
        ...
        <form action="#" method="POST">
            ...
            <a href="hospital_register.php" class="btn ml-n2 text-muted">New Hospital? <u>SignUp</u></a>

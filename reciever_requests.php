<?php
    ...
    if($hospital != "" && $hospital_logged == 1){
        unset($_SESSION['hospitalId']);	
        unset($_SESSION['hospitalName']);	
        header('location:login_reciever.php');
    }
    elseif($user == "" && $reciever_logged == 0){
        header('location:login_reciever.php');
    }
    else{
        $req_info = mysqli_query($db, "SELECT * FROM requests INNER JOIN hospital ON requests.h_id = hospital.h_id WHERE requests.r_id = '$userId';");
    ...
    <div class="container">
        <section class="section1 mt-3" style="height: 35vh;">
            <header class="text-center">
                <h1 class=" header-text">Your Requests</h1>
            </header>
        </section>
            ...
            ?>
                <div class="bld-grp mt-3 mb-5">
                    ...
                    <div class="info">
                        ...
                        <h2>Hospital Info</h2>
                        <h6><i class="las la-hospital-alt"></i> <?php echo $row['h_name'];?></h6>
                        <h6 style="text-transform: lowercase;"><i class="las la-at"></i> <?php echo $row['h_email'];?></h6>
                        <h6 style="text-transform: uppercase;"><i class="las la-map-pin"></i> <?php echo $row['h_city'];?></h6>
                        <h6><i class="las la-phone"></i> +91 <?php echo $row['h_phone'];?></h6>
                    </div>
                </div>
                <?php
        }
